...
<form class="form-signin mt-10" action="processSignUp.php" method="post">
      
      <h1 class="h3 mb-3 font-weight-normal">Please sign up</h1>

      <label for="inputEmail" class="sr-only">Username</label>
      <input type="text" id="inputEmail" class="form-control" placeholder="Username" required autofocus name="txtUser">
      ...
      <input type="password" id="inputRetypePassword" class="form-control" placeholder="Password" required name="inputRetypePassword">
        <?php
